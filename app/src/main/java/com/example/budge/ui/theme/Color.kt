...
// Light theme colors (Material 3 baseline palette)
...
// Dark theme colors (Material 3 baseline palette)
...
// Semantic "money in" color. Material 3 has no role for it, but hardcoding the
// literal in each screen produced six copies and used a light green on a light
// surface (about 1.9:1 contrast, well under the 4.5:1 minimum for text).
// Light theme therefore uses a darker green, dark theme the lighter tint.
val md_theme_light_income = Color(0xFF2E7D32)
